...
class CaiInstallGUI(ttk.Window):
    def __init__(self):
        super().__init__(themename="darkly", title="Cai Install XP v1.50p1 - GUI Edition")
    ...
    def create_widgets(self):
        ...
        # --- MODIFICATION: Manager button is now here ---
    ...
    def show_about_dialog(self):
        messagebox.showinfo("关于", "Cai Install XP v1.50p1 - GUI Edition\n\n原作者: pvzcxw\nGUI重制: pvzcxw\n\n一个用于Steam游戏清单获取和导入的工具")
